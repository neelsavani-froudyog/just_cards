...
class OrganizationMembersShimmerView extends StatefulWidget {
  const OrganizationMembersShimmerView({super.key});

  @override
  State<OrganizationMembersShimmerView> createState() =>
      _OrganizationMembersShimmerViewState();
}

class _OrganizationMembersShimmerViewState
    extends State<OrganizationMembersShimmerView>
